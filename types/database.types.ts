...
/**
 * System variables that are auto-generated by the platform
 * These provide runtime context like current date/time and phone numbers
 */
export const SYSTEM_VARIABLES: Omit<CustomVariableDefinition, 'id' | 'created_at'>[] = [
  {
    name: "CURRENT_DATE_TIME",
    description: "Current date & time in workspace timezone (e.g., '9 Feb 2026, 14:30')",
    default_value: "",
    is_required: false,
    category: "standard",
    is_standard: true,
...
export const STANDARD_CAMPAIGN_VARIABLES: Omit<CustomVariableDefinition, 'id' | 'created_at'>[] = [
  ...
  {
    name: "phone_number",
    description: "Recipient's phone number (alias for CUSTOMER_PHONE)",
    default_value: "",
    is_required: true,
    category: "standard",
    is_standard: true,
