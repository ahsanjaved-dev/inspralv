        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          <div className="flex justify-center mb-8">
            <Badge variant="secondary" className="px-4 py-1.5 gap-2">
              ...
              Powered by VAPI, Retell & Synthflow
            </Badge>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground text-center max-w-2xl mx-auto mb-10 leading-relaxed">
            Build intelligent voice agents in minutes. Automate customer calls, 
            handle inquiries 24/7, and scale your business with conversational AI.
          </p>
            ...
            {[
              {
                ...
                description: "Ultra-realistic voices with emotion, tone, and natural speech patterns.",
              },
              {
                icon: MessageSquare,
                title: "Smart Conversations",
                description: "Context-aware dialogue that understands intent and handles interruptions.",
              },
              {
                icon: Phone,
                title: "Phone Integration",
                description: "Connect to any phone system. Handle inbound, outbound, and transfers.",
              },
              {
                icon: BarChart3,
            ...
            {[
              {
                ...
                description: "Handle support tickets 24/7. Resolve issues instantly. Escalate when needed.",
                icon: Headphones,
                stats: "85% resolution rate"
              },
              {
                title: "Sales & Lead Qualification",
                description: "Qualify leads automatically. Book meetings. Follow up at the perfect time.",
                icon: Users,
                stats: "3x more qualified leads"
              },
              {
                title: "Appointment Scheduling",
                description: "Let customers book, reschedule, and cancel appointments over the phone.",
                icon: Clock,
                stats: "60% fewer no-shows"
              },
              {
                title: "Outbound Campaigns",
                description: "Run personalized outbound campaigns at scale. Track results in real-time.",
                icon: Phone,
          ...
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
                Join thousands of businesses using AI voice agents to automate conversations and delight customers.
              </p>
